...
def main():
    ...
    # Use image 2 as the center base!
    center_idx = 2
    
    h, w = images[center_idx].shape[:2]
    canvas_w = int(w * 4) # make canvas a bit wider just in case
    canvas_h = int(h * 2)
    ...
    print(f"Saved correctly aligned 3-photo stitch to {output_path}")
