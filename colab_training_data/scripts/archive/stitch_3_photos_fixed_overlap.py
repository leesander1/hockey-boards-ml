...
def main():
    ...
    # FIX: Draw Center First! Then draw Left (0) and Right (2) on top.
    # This prevents the center image from overwriting the extended edges of the side images.
    ...
    output_path = "/Users/leesander/.gemini/antigravity/brain/d5aae78c-4b02-47aa-b503-4927926f04c0/artifacts/stitched_3_photos_fixed_overlap.jpg"
    cv2.imwrite(output_path, result)
    print(f"Saved correctly overlapped 3-photo stitch to {output_path}")
