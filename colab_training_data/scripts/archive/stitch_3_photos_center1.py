...
def main():
    ...
    center_idx = 1  # Use middle image as the canvas center!
    ...
    output_path = "/Users/leesander/.gemini/antigravity/brain/d5aae78c-4b02-47aa-b503-4927926f04c0/artifacts/stitched_3_photos_center1_homography.jpg"
    cv2.imwrite(output_path, result)
    print(f"Saved homography 3-photo stitch with center 1 to {output_path}")
