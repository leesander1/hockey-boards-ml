...
def main():
    ...
    # To avoid 0 overwriting 1 where it has bad edges, let's draw them in this order:
    # 0 and 2 first, then 1 (the center) on top.
    ...
    output_path = "/Users/leesander/.gemini/antigravity/brain/d5aae78c-4b02-47aa-b503-4927926f04c0/artifacts/stitched_3_photos_center1_affine.jpg"
