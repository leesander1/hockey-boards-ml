...
def main():
    ...
    for img in images:
        ...
        # Use almost the whole image to catch faceoff circles, exclude extreme top and bottom UI
    ...
    output_path = "/Users/leesander/.gemini/antigravity/brain/d5aae78c-4b02-47aa-b503-4927926f04c0/artifacts/stitched_3_photos_homography.jpg"
    cv2.imwrite(output_path, result)
    print(f"Saved homography 3-photo stitch to {output_path}")
